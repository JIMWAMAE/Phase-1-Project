...
Recommendations
The studio should aim at producing movies with relatively short runtime as it is inversely related to average rating.
The studio should aim at producing the top preffered genres that have a high average rating as it will in the long run facilitate movie success.
The studio should aim at using the top directors and writters according to experience in the industry according to their average ratings.
The studio should aim at assigning the required budget and not under funding their movie projects since from the data movies with high budgets generated higher revenue.
Summary
